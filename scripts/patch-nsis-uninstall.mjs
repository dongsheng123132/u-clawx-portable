 ...
 * shows a misleading "app cannot be closed" dialog even when U-ClawX is not running.
 */
...
const PATCH_MARKER = 'U-ClawX-patched: skip legacy uninstaller';

const SKIP_LEGACY_UNINSTALLER = [
  '  ; U-ClawX-patched: skip legacy uninstaller on upgrades.',
