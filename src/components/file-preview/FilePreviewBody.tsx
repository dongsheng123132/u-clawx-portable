        ...
        {allowSystemActions && <p className="max-w-md text-xs leading-relaxed text-muted-foreground">
          {directOpen
            ? t('filePreview.errors.largeBinaryOpenHint', {
              defaultValue: 'This file is {{size}}. U-ClawX does not provide an inline preview for it. You can confirm to open it directly in your system default app.',
          ...
          <div className="space-y-1.5">
            ...
            {allowSystemActions && <p className="max-w-md text-xs leading-relaxed text-muted-foreground">
              {t(
                ...
                'U-ClawX cannot read this path. The file may have been moved, deleted, or may not be accessible to the current account. You can inspect it in your file manager.',
              )}
            </p>}
          </div>
          {allowSystemActions && <Button variant="outline" size="sm" onClick={handleOpenInFinder}>
