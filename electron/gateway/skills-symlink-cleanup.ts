...
import { getOpenClawConfigDir, getOpenClawResolvedDir, getOpenClawSkillsDir, getPersonalAgentsDir } from '../utils/paths';
...
function defaultAgentsDir(): string {
  return path.join(getPersonalAgentsDir(), 'skills');
}
